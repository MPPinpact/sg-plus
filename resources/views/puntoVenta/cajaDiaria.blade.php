	    ...
	    <div class="card">
			...
			<div class="card-block">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-2">
                			<a  href="#" style="float:left;" class="btn-xlg btn-primary waves-effect waves-light btn-block" href="#primary" role="button">
						...
						<div class="col-md-2">
							<a  href="{{ URL::route('cajaDiariaResumen') }}" style="float:left;" name="botonCDR" id="botonCDR" class="btn-xlg btn-primary waves-effect waves-light btn-block" href="#primary" role="button">
						...
						<div class="col-md-2">
							<a  href="{{ URL::route('cajaDiariaResumenVenta') }}" style="float:left;" name="botonCDRV" id="botonCDRV" class="btn-xlg btn-primary waves-effect waves-light btn-block" href="#primary" role="button">
