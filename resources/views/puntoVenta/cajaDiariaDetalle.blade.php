			...
			<div class="card-block">
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-2">
							<a  href="{{ URL::route('cajaDiariaDetalle') }}" style="float:left;" name="botonCDD" id="botonCDD" class="btn btn-inverse-warning waves-effect waves-light btn-block" href="#primary" role="button">
