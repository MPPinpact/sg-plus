			...
			<div class="card-block">
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-2">
							<button style="float:left;" href="{{ URL::route('cajaDiariaResumen') }}" name="botonCDR" id="botonCDR" type="button" class="btn-xlg btn-primary waves-effect waves-light btn-block">
