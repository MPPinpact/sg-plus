		                ...
		                <div class="product-edit">
		                    ...
		                    <div class="tab-content">
		                        <div class="tab-pane active" id="detalles" role="tabpanel">
                   					<br><br>
                   					<?php echo Form::open(['id'=>'FormCredito','autocomplete' => 'off']); ?>

									<?php echo Form::hidden('IdCreditoPreferencia', '', [
...
<script Language="Javascript">
	var ruta = "<?php echo e(URL::route('credito')); ?>"
	var d = [];
	d['v_credito_preferencias'] = JSON.parse(rhtmlspecialchars('<?php echo e(json_encode($v_credito_preferencias)); ?>'));
	
</script>
<script src="<?php echo e(asset('js/credito/credito.js')); ?>"></script>
