		...
		<div class="card">
			...
			<div class="card-block">
				...
				<div style="display:none;" class="col-md-12 divForm">
					...
					<?php echo Form::open(['id'=>'FormImpuestos','autocomplete' => 'off']); ?>

					<?php echo Form::hidden('IdImpuesto', '', [
					'id'            => 'IdImpuesto',
					'class'         => 'form-control']); ?>
...
<script Language="Javascript">
	var ruta = "<?php echo e(URL::route('impuestos')); ?>"
	var rutaA = "<?php echo e(URL::route('activarI')); ?>"
	var rutaB = "<?php echo e(URL::route('impuestob')); ?>"
	var d = [];
...
<script src="<?php echo e(asset('js/impuestos/impuestos.js')); ?>"></script>
