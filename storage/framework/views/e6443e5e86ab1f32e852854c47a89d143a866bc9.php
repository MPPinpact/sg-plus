						...
						<div class="product-edit">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="detalles" role="tabpanel">
									<br><br>
									<?php echo Form::open(['id'=>'FormEmpresa','autocomplete' => 'off']); ?>

									<?php echo Form::hidden('IdEmpresa', '', [
									'id'            => 'IdEmpresa',
									'class'         => 'form-control']); ?>
...
<script Language="Javascript">
	var ruta = "<?php echo e(URL::route('empresas')); ?>"
	var rutaA = "<?php echo e(URL::route('activarE')); ?>"
	var rutaD = "<?php echo e(URL::route('detallesE')); ?>"
	var d = [];
...
<script src="<?php echo e(asset('js/empresas/empresas.js')); ?>"></script>
