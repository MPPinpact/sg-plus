	    ...
	    <div class="card">
	        ...
	        <div class="card-block">
				...
				<div style="display:none;" class="col-md-12 divForm">
					...
					<?php echo Form::open(['id'=>'FormCliente','autocomplete' => 'off']); ?>

					<?php echo Form::hidden('IdCliente', '', [
					'id'            => 'IdCliente',
					'class'         => 'form-control']); ?>
...
<script Language="Javascript">
	var ruta = "<?php echo e(URL::route('clientes')); ?>"
	...
	var d = [];
	d['v_clientes'] = JSON.parse(rhtmlspecialchars('<?php echo e(json_encode($v_clientes)); ?>'));
...
<script src="<?php echo e(asset('js/clientes/clientes.js')); ?>"></script>
