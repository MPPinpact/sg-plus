		                ...
		                <div class="product-edit">
		                    ...
		                    <div class="tab-content">
		                        <div class="tab-pane active" id="detalles" role="tabpanel">
									<br><br>
									<?php echo Form::open(['id'=>'FormBodega','autocomplete' => 'off']); ?>

									<?php echo Form::hidden('IdBodega', '', [
									'id'            => 'IdBodega',
									'class'         => 'form-control']); ?>
...
<script Language="Javascript">
	var ruta = "<?php echo e(URL::route('bodegas')); ?>"
...
<script src="<?php echo e(asset('js/bodegas/bodegas.js')); ?>"></script>
